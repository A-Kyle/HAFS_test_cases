...
#ifdef IDEAL_MOD
   use test_control_mod,    only: selected_case
   use test_init_mod,       only: read_test_nml
#endif
...
#ifdef IDEAL_MOD
     call read_test_nml(Atm(this_grid)%nml_filename)
#endif
     call read_namelist_test_case_nml(Atm(this_grid)%nml_filename) !< could be redundant/defunct with IDEAL_MOD
